  ...
  useEffect(() => {
    const fetchResults = async () => {
      const res = await fetch(
        `https://pak-backend-r5516yojy-hamza-maliks-projects-598e98c2.vercel.app/createAdvertisement/search${location.search}`);
          ...
          results.map((car) => (
            <article key={car._id} className="card">
              <div style={{ display: "flex", flexDirection: "row" }}>
                <img
                  src={`https://pak-backend-r5516yojy-hamza-maliks-projects-598e98c2.vercel.app/uploads/${car.Image}`}
                  alt={car.Name}
                />
