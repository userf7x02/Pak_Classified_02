...
export default function Categories() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        // Step 1: Get all categorieshttps://pak-backend-lxhqundby-hamza-maliks-projects-598e98c2.vercel.app
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          try {
            const res2 = await fetch(
              `https://pak-backend-lxhqundby-hamza-maliks-projects-598e98c2.vercel.app/createAdvertisement/category/${c._id}`
