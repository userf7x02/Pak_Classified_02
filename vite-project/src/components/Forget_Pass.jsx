...
export default function ForgotPassword({ show, handleClose }) {
    ...
    const sendOtp = async () => {
        try {
            const res = await fetch("https://pak-backend-bku89l3fn-hamza-maliks-projects-598e98c2.vercel.app/createAuth/forgot", {
                method: "POST",
    ...
    const resetPassword = async () => {
        try {
            const res = await fetch("https://pak-backend-bku89l3fn-hamza-maliks-projects-598e98c2.vercel.app/createAuth/reset", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
