...
export default function CatDesign() {
  ...
  async function Getdata() {
    try {
      let res = await fetch(`https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app
          ...
          Card.map((car) => (
            <article key={car._id} className="card">
              <div style={{ display: "flex", flexDirection: "row" }}>
                <img
                  src={`https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app
/uploads/${car.Image}`}
                  alt={car.Name}
                />
