...
export default function CarDetails() {
  ...
  //   try {
  //     const res = await fetch("https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app/createCategory/Get");
  ...
  const getCityArea = async () => {
    try {
      const res = await fetch("https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app/createArea/Get")
      const data = await res.json();
  ...
  useEffect(() => {
    fetch(`https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app/createAdvertisement/${id}`, {
  ...
  if (!ad) return <h2 className="text-center">Loading...</h2>;
      ...
      <div style={styles.wrap}>
        ...
        <div style={styles.topRow}>
          <div
            style={{
              ...styles.thumb,
              backgroundImage: `url(https://pak-backend-54jpb4etr-hamza-maliks-projects-598e98c2.vercel.app/uploads/${ad.Image || "placeholder.jpg"})`,
            }}
          ></div>
