...
export default function CarDetails() {
  ...
  useEffect(() => {
    fetch(`https://pak-backend-lxhqundby-hamza-maliks-projects-598e98c2.vercel.app/createAdvertisement/${id}`, {
      ...
      <div style={styles.wrap}>
        ...
        <div style={styles.topRow}>
          <div
            style={{
              ...styles.thumb,
              backgroundImage: `url(https://pak-backend-lxhqundby-hamza-maliks-projects-598e98c2.vercel.app/uploads/${ad.Image || "placeholder.jpg"})`,
            }}
          ></div>
